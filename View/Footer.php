            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="footer-about-us">
                        <h2 style="font-family:Impact;">OneClick<span>Store</span></h2>
                       <address>
                        <span>Chuyên cung cấp các sản phẩm công nghệ!</span>
                        <p><i class="fa fa-phone"></i> +84-969-123-456</p>
                        <p><i class="fa fa-map-marker"></i>km10 Trần Phú - Mỗ Lao - Hà Đông - Hà Nội</p>
                    </address>
                        <div class="footer-social">
                            <a href="https://www.facebook.com/Oneclickstore-100628372252444" target="_blank"><i class="fab fa-facebook"></i></a>
